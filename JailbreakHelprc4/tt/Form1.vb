...
Public Class Form1
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        'Credits!
        MessageBox.Show("Jailbreak Help rc4 by the Private Dev team. Fallensn0w for mobiledevice, stantheripper for entering/exiting recovery (did not copy and paste, it was simply used as a template). Images used are protected under fair use. This is open source!", "Jailbreak Help rc4")
    End Sub
